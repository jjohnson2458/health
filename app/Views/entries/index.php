            ...
            <table class="table table-hover table-sm mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th><?= e(isMetric() ? __('entry.weight_metric') : __('entry.weight')) ?></th>
                        <th><?= e(__('entry.calories')) ?></th>
                        <th class="d-none d-md-table-cell"><?= e(__('entry.heart_rate')) ?></th>
                        <th class="d-none d-md-table-cell"><?= e(isMetric() ? __('entry.blood_sugar_metric') : __('entry.blood_sugar')) ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= displayWeight($entry['weight'] ? (float)$entry['weight'] : null) ?></td>
                        <td><?= $entry['calories'] ?? '--' ?></td>
                        <td class="d-none d-md-table-cell"><?= $entry['heart_rate'] ?? '--' ?></td>
                        <td class="d-none d-md-table-cell"><?= displayBloodSugar($entry['blood_sugar'] ? (float)$entry['blood_sugar'] : null) ?></td>
