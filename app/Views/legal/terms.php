    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <h3 class="text-center mb-4"><i class="bi bi-file-text"></i> <?= e(__('legal.terms_title')) ?></h3>
                ...
                <ul>
                    ...
                    <li>Use the Service to store information for anyone other than yourself without proper authorization</li>
                </ul>
                ...
                <p>VisionQuest Services LLC shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of the Service. The Service is provided "as is" without warranties of any kind.</p>

                <h5>8. Termination</h5>
                <p>We reserve the right to suspend or terminate your account if you violate these Terms. You may delete your account at any time. Upon deletion, your data will be permanently removed.</p>

                <h5>9. Changes to Terms</h5>
                <p>We may update these Terms from time to time. Continued use of the Service after changes constitutes acceptance of the new Terms.</p>

                <h5>10. Contact</h5>
                <p>For questions about these Terms, contact us at: <a href="mailto:email4johnson@gmail.com">email4johnson@gmail.com</a></p>
