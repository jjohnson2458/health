<?php
/**
 * PHPDoc Generator for VQ Healthy
 *
...
<head>
    ...
    <title>VQ Healthy API Documentation</title>
...
<nav class="sidebar" id="sidebar">
    <div class="px-4 pb-3 d-flex align-items-center justify-content-between">
        <div>
            <h6 class="mb-0 fw-bold"><i class="bi bi-heart-pulse me-1"></i> VQ Healthy</h6>
...
<div class="main-content">
    ...
    <section id="overview">
        <div class="hero-section">
            <h1 class="mb-1"><i class="bi bi-heart-pulse me-2"></i>VQ Healthy</h1>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p class="mb-2">This documentation covers the VQ Healthy application's PHP backend, organized by namespace. The codebase follows an MVC architecture with a custom micro-framework.</p>
                <ul class="mb-2">
...
<?php endforeach; ?>
    ...
    <footer class="border-top pt-3 mt-5 text-muted">
        ...
        <p class="mt-2 mb-0"><small class="text-muted">VQ Healthy &copy; <?= date('Y') ?> &mdash; HIPAA-Compliant Health Tracking Platform</small></p>
    </footer>
